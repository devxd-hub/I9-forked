...
const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    description:
      'Weekly studio labs are dedicated to rapid prototyping. We pair-program on core rendering engines, mill physical wood and acrylic enclosures in the makerspace, and run peer reviews every Thursday evening.',
    deliverables: [
