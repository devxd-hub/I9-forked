...
export const AboutPreview: React.FC<AboutPreviewProps> = ({ onRouteChange }) => {
  return (
    <RevealSection
      ...
      className="w-full py-20 sm:py-28 md:py-36 border-b border-[rgba(10,10,9,0.12)] bg-[#F3EEE5] overflow-hidden"
    >
      <Container>
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="col-span-4 md:col-span-8 lg:col-span-6 order-1 lg:order-2 space-y-6 sm:space-y-8">
