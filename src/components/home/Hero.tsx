          ...
          >
            ...
            >
              <span
                ...
                className="inline-flex items-center font-fraunces font-bold uppercase select-none text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[6.5rem] tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.22em] text-[#0A0A09]"
                aria-label="NEXUS"
              >
                <span
                  ref={neRef}
              ...
              <span
                ref={subtitleRef}
                className="font-dosis uppercase font-semibold tracking-[0.35em] text-sm md:text-base text-[#66615A] mt-1 sm:mt-2 transition-opacity duration-75 ease-out"
