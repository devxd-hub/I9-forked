  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`h-9 px-3 flex items-center justify-between border-b cursor-grab active:cursor-grabbing select-none shrink-0 transition-colors ${
          isActive
      ...
      >
        ...
        {/* Linux-Style Right Window Control Buttons (Minimize, Maximize, Close) */}
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            className="w-5 h-5 flex items-center justify-center rounded-[2px] bg-white/[0.06] hover:bg-white/[0.14] text-[#A6A095] hover:text-white transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="w-5 h-5 flex items-center justify-center rounded-[2px] bg-white/[0.06] hover:bg-[#EF5A2A] text-[#A6A095] hover:text-white transition-colors cursor-pointer"
          >
            <X className="w-3 h-3" />
          </button>
        </div>
